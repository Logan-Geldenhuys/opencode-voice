...
export const DEFAULT_WAKE_PHRASES = [
  ...
  // name comes back as "nome", "node" and "noam", including "Hey, Noam," with
  // the commas. "norm", "gnome", "nom" and "no me" are absent from the short
  // list deliberately: those are the forms that collide with ordinary speech,
  // and they are the reason a short phrase looked unusable. "hey norm" is a
  // colleague, "hey gnome" is a desktop, "hey no me" is the tail of "no, me
  // neither". Each of them keeps its longer form above and loses nothing.
  //
