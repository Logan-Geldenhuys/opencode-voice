...
export const DEFAULT_WAKE_PHRASES = [
  ...
  // this speaker's own voice has produced "node", "norm", "nom", "gnome" and
  // "no me" on the same microphone, and adding "Nome" to sttVocabulary did not
  // shift any of them. No variant list for a two-token phrase can be complete,
  // so the name is not what the phrase rests on.
  //
